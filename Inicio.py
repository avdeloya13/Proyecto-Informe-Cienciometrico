...
st.set_page_config(page_title="Estudio Cienciométrico", layout="wide")

st.title("📚 La Investigación Científica en el Instituto de Ciencias Nucleares de la UNAM")
st.markdown("---")
...
* **Visibilidad e Impacto** (citas y percentiles por campo).
* **Colaboración** (nacional, internacional e interinstitucional).
* **Diversidad y Evolución Temática**.
""")

st.info("Utiliza el menú lateral para navegar entre las diferentes secciones en las que fue dividido el estudio.")